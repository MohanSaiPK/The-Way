...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full bg-[#1A1A1A] text-white  flex items-center z-50 p-2">
      <img src={logo} alt="TheWay Logo" className="w-10 md:w-16" />
      <div className="flex items-center justify-between w-full pr-4">
        <div className="md:text-2xl font-bold">GYM STORE</div>
        {!isAuthPage && token && (
